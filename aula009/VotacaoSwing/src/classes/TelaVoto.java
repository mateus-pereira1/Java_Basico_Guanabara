...
public class TelaVoto extends javax.swing.JFrame {
    ...
    private void btnVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotoActionPerformed
        ...
        if(idade < 16){
            lblResultado.setText("Não vota, pois tem "+idade+" anos");
        } else if(idade >= 16 && idade < 18 || idade > 70){
            lblResultado.setText("Voto opcional, pois tem "+idade+" anos");
        } else{
            lblResultado.setText("Voto obrigatório, pois tem "+idade+" anos");
        }
